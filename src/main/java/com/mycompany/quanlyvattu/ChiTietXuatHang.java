...
public class ChiTietXuatHang extends javax.swing.JFrame {
    ...
    public ChiTietXuatHang() {
        initComponents();
        nhomsp_data.loadCBGroup(cb_GrProduct);
        loadCBTenSP();
    ...
    public void loadCBTenSP(){
      GroupItem selectedGroup = (GroupItem) cb_GrProduct.getSelectedItem();
        if (selectedGroup != null) {
            int groupId = selectedGroup.getId();
            NHOMSP_DATA.loadCategoryByGroupId(cb_Brand, groupId);
        }
}
    ...
    private void initComponents() {
        ...
        cb_Brand.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
